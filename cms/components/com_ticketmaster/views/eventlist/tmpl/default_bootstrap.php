...
<?php }else{ ?>
    ...
    <table class="table">
        ...
        <thead>
            <th width="40%"><?php echo JText::_( 'COM_TICKETMASTER_TM_EVENTS' ); ?></th>
            <th width="30%"><div align="center"><?php echo JText::_( 'COM_TICKETMASTER_DATE' ); ?></div></th>
            <th width="10%"><div align="center"><?php echo JText::_( 'COM_TICKETMASTER_PRICE' ); ?></div></th>
            <th width="20%"></th>
        </thead>
