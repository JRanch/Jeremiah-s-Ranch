 ...
 * @since		1.6
 */
class JFormFieldModal_EventLists extends JFormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since	1.6
	 */
	protected $type = 'Modal_EventLists';
	...
	protected function getInput()
	{
		...
		if (empty($title)) {
			$title = JText::_('COM_TICKETMASTER_SELECT_EVENTLIST');
		}

		//$link = 'index.php?option=com_contact&amp;view=contacts&amp;layout=modal&amp;tmpl=component&amp;function=jSelectChart_'.$this->id;
		$link = 'index.php?option=com_ticketmaster&amp;controller=events&amp;task=modal&amp;tmpl=component&amp;function=jSelectChart_'.$this->id;
